...
{
    public partial class updatedsomeendpoints : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Thriller 25", 1, null, 110, "Beat it" },
                    { 2, "Jail house rock", 2, null, 130, "Jail house rock" },
                    { 3, "Fire in the church", 3, null, 170, "Fire in the church" },
                    { 4, "Tha carter 3", 4, null, 140, "A mili" }
                });
